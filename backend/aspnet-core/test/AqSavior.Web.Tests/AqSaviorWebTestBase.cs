...
{
    public abstract class AqSaviorWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AqSaviorWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AqSaviorWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AqSaviorDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AqSaviorDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AqSaviorDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AqSaviorDbContext, Task<T>> func)
        {
            T result;
